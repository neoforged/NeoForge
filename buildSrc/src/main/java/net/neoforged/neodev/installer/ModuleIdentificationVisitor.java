...
abstract class ModuleIdentificationVisitor {
    ...
    final void visitFiles(FileCollection files) throws IOException {
        for (var file : files) {
    ...
    protected abstract void visitModule(File file, String group, String module, String version, String classifier, String extension) throws IOException;
}
