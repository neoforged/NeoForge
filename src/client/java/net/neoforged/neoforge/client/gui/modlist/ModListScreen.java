...
public class ModListScreen extends Screen {
    ...
    public static ModListScreen create() {
        ...
        if (!FMLEnvironment.isProduction()) {
            ...
            mods.add(TestingResources.exercise());
        }
    ...
    protected void init() {
        ...
        this.search = this.fixedSidebarLayout.addChild(new EditBox(this.font, SIDEBAR_CONTROLS_WIDTH - SIDEBAR_SORT_BUTTON_WIDTH - 2, SIDEBAR_CONTROLS_HEIGHT, Component.translatable("neoforge.screen.mods.search")));
