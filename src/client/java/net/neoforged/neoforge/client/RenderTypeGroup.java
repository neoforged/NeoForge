 ...
 * and the other two using {@link com.mojang.blaze3d.vertex.DefaultVertexFormat#ENTITY}.
 */
public record RenderTypeGroup(ChunkSectionLayer block, RenderType entityBlock, RenderType entityItem) {
    public RenderTypeGroup {
        ...
        if (entityBlock != null && (entityBlock.format() != DefaultVertexFormat.ENTITY || entityItem.format() != DefaultVertexFormat.ENTITY)) {
