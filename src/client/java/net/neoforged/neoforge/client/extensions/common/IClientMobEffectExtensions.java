...
public interface IClientMobEffectExtensions {
    ...
    /// @implNote By default, this returns `true`.
    ...
    /// @deprecated Use [IClientMobEffectExtensions#extractInventoryIcon]
    ...
    /// Extracts the icon of the specified effect in the player's inventory.
    ///
    /// @param instance The effect instance
    /// @param screen   The effect-rendering screen
    ...
    /// @param blitOffset  The blit offset
    /// @return `true` to prevent default rendering, `false` otherwise
    /// @deprecated Use [IClientMobEffectExtensions#extractInventoryText]
    @Deprecated(forRemoval = true, since = "26.1.2")
    ...
    /// Extracts the text of the specified effect in the player's inventory.
    ///
    /// @param instance    The effect instance
    /// @param screen      The effect-rendering screen
    /// @param graphics    The gui graphics
    ...
    /// @return `true` to prevent default rendering, `false` otherwise
    /// @deprecated Use [IClientMobEffectExtensions#extractGuiIcon]
    @Deprecated(forRemoval = true, since = "26.1.2")
    ...
    /// Extracts the icon of the specified effect on the player's HUD.
    /// This can be used to render icons from your own texture sheet.
    ///
    /// @param instance The effect instance
    /// @param gui      The gui
