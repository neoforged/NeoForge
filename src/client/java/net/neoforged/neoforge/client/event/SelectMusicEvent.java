...
/// It is therefore preferred to call the [SelectMusicEvent#overrideMusic(Music)][SelectMusicEvent#overrideMusic(Music)] helper with your music, which automatically cancels the event for you.
///
/// This event is fired on the [main Forge event bus][NeoForge#EVENT_BUS],
