...
public abstract class RenderGuiLayerEvent extends Event {
    ...
    private final GuiLayerManager.Layer layer;

    @ApiStatus.Internal
    protected RenderGuiLayerEvent(GuiGraphics guiGraphics, DeltaTracker partialTick, ResourceLocation name, GuiLayerManager.Layer layer) {
    ...
    public GuiLayerManager.Layer getLayer() {
        return layer;
    }
    ...
    public static class Pre extends RenderGuiLayerEvent implements ICancellableEvent {
        @ApiStatus.Internal
        public Pre(GuiGraphics guiGraphics, DeltaTracker partialTick, ResourceLocation name, GuiLayerManager.Layer layer) {
    ...
    public static class Post extends RenderGuiLayerEvent {
        @ApiStatus.Internal
        public Post(GuiGraphics guiGraphics, DeltaTracker partialTick, ResourceLocation name, GuiLayerManager.Layer layer) {
            super(guiGraphics, partialTick, name, layer);
        }
    }
}
