...
public final class TagConventionLogWarning {
    ...
    private static final Map<TagKey<?>, TagKey<?>> LEGACY_FORGE_TAGS = Map.<TagKey<?>, TagKey<?>>ofEntries(
            ...
            createMapEntry(Registries.BLOCK, "crafting_table", Tags.Items.PLAYER_WORKSTATIONS_CRAFTING_TABLES),
            createMapEntry(Registries.BLOCK, "crafting_tables", Tags.Items.PLAYER_WORKSTATIONS_CRAFTING_TABLES),
            ...
            createMapEntry(Registries.BLOCK, "furnace", Tags.Items.PLAYER_WORKSTATIONS_FURNACES),
            createMapEntry(Registries.BLOCK, "furnaces", Tags.Items.PLAYER_WORKSTATIONS_FURNACES),
