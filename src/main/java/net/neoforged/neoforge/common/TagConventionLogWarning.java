...
public final class TagConventionLogWarning {
    ...
    private static final Map<TagKey<?>, String> LEGACY_FORGE_TAGS = Map.<TagKey<?>, String>ofEntries(
            ...
            createMapEntry(Registries.BLOCK, "minecraft", "small_flowers", Tags.Blocks.FLOWERS_SMALL),
            createMapEntry(Registries.BLOCK, "minecraft", "tall_flowers", Tags.Blocks.FLOWERS_TALL),
            createMapEntry(Registries.BLOCK, "minecraft", "flowers", Tags.Blocks.FLOWERS),
            ...
            createMapEntry(Registries.ITEM, "minecraft", "small_flowers", Tags.Items.FLOWERS_SMALL),
