...
public final class NeoForgeBiomeTagsProvider extends BiomeTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider lookupProvider) {
        ...
        tag(Biomes.OLD_GROWTH_BIRCH_FOREST, Tags.Biomes.IS_DENSE_VEGETATION_OVERWORLD, Tags.Biomes.IS_RARE, Tags.Biomes.IS_OLD_GROWTH);
        tag(Biomes.OLD_GROWTH_PINE_TAIGA, Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_CONIFEROUS, Tags.Biomes.IS_OLD_GROWTH);
        ...
        tag(Biomes.WINDSWEPT_SAVANNA, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_DRY_OVERWORLD, Tags.Biomes.IS_SPARSE_VEGETATION_OVERWORLD, Tags.Biomes.IS_WINDSWEPT, Tags.Biomes.IS_RARE);
        ...
        tag(Biomes.WINDSWEPT_FOREST, Tags.Biomes.IS_SPARSE_VEGETATION_OVERWORLD, Tags.Biomes.IS_WINDSWEPT);
