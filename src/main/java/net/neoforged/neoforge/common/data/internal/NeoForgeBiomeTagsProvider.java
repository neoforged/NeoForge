...
public final class NeoForgeBiomeTagsProvider extends BiomeTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider lookupProvider) {
        ...
        tag(Biomes.FOREST, Tags.Biomes.IS_DECIDUOUS_TREE);
        tag(Biomes.FLOWER_FOREST, Tags.Biomes.IS_RARE, Tags.Biomes.IS_DECIDUOUS_TREE);
        tag(Biomes.BIRCH_FOREST, Tags.Biomes.IS_DECIDUOUS_TREE);
        tag(Biomes.DARK_FOREST, Tags.Biomes.IS_SPOOKY, Tags.Biomes.IS_DENSE_VEGETATION_OVERWORLD, Tags.Biomes.IS_DECIDUOUS_TREE);
        tag(Biomes.SWAMP, Tags.Biomes.IS_WET_OVERWORLD, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_SWAMP);
        tag(Biomes.MANGROVE_SWAMP, Tags.Biomes.IS_WET_OVERWORLD, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_SWAMP);
        tag(Biomes.TAIGA, Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_CONIFEROUS_TREE);
        tag(Biomes.OLD_GROWTH_BIRCH_FOREST, Tags.Biomes.IS_DENSE_VEGETATION_OVERWORLD, Tags.Biomes.IS_RARE, Tags.Biomes.IS_OLD_GROWTH, Tags.Biomes.IS_DECIDUOUS_TREE);
        tag(Biomes.OLD_GROWTH_PINE_TAIGA, Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_CONIFEROUS_TREE, Tags.Biomes.IS_OLD_GROWTH);
        tag(Biomes.OLD_GROWTH_SPRUCE_TAIGA, Tags.Biomes.IS_DENSE_VEGETATION_OVERWORLD, Tags.Biomes.IS_RARE, Tags.Biomes.IS_OLD_GROWTH);
        tag(Biomes.JUNGLE, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_WET_OVERWORLD, Tags.Biomes.IS_DENSE_VEGETATION_OVERWORLD, Tags.Biomes.IS_JUNGLE_TREE);
        tag(Biomes.BAMBOO_JUNGLE, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_WET_OVERWORLD, Tags.Biomes.IS_RARE, Tags.Biomes.IS_JUNGLE_TREE);
        tag(Biomes.SPARSE_JUNGLE, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_WET_OVERWORLD, Tags.Biomes.IS_RARE, Tags.Biomes.IS_JUNGLE_TREE);
        ...
        tag(Biomes.SAVANNA, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_SPARSE_VEGETATION_OVERWORLD, Tags.Biomes.IS_SAVANNA_TREE);
        tag(Biomes.SAVANNA_PLATEAU, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_SPARSE_VEGETATION_OVERWORLD, Tags.Biomes.IS_RARE, Tags.Biomes.IS_MOUNTAIN_SLOPE, Tags.Biomes.IS_PLATEAU, Tags.Biomes.IS_SAVANNA_TREE);
        tag(Biomes.WINDSWEPT_SAVANNA, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_DRY_OVERWORLD, Tags.Biomes.IS_SPARSE_VEGETATION_OVERWORLD, Tags.Biomes.IS_WINDSWEPT, Tags.Biomes.IS_RARE, Tags.Biomes.IS_SAVANNA_TREE);
        ...
        tag(Biomes.WINDSWEPT_FOREST, Tags.Biomes.IS_SPARSE_VEGETATION_OVERWORLD, Tags.Biomes.IS_WINDSWEPT, Tags.Biomes.IS_DECIDUOUS_TREE);
        tag(Biomes.WINDSWEPT_HILLS, Tags.Biomes.IS_SPARSE_VEGETATION_OVERWORLD, Tags.Biomes.IS_WINDSWEPT);
        tag(Biomes.WINDSWEPT_GRAVELLY_HILLS, Tags.Biomes.IS_SPARSE_VEGETATION_OVERWORLD, Tags.Biomes.IS_WINDSWEPT, Tags.Biomes.IS_RARE);
        ...
        tag(Biomes.GROVE, Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_CONIFEROUS_TREE, Tags.Biomes.IS_SNOWY, Tags.Biomes.IS_MOUNTAIN_SLOPE);
