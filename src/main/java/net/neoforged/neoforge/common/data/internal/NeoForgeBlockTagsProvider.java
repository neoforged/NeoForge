...
public final class NeoForgeBlockTagsProvider extends BlockTagsProvider {
    ...
    public void addTags(HolderLookup.Provider p_256380_) {
        ...
        tag(Tags.Blocks.CHAINS).addTags(Tags.Blocks.CHAINS);
        ...
        tag(Tags.Blocks.HEADS).add(Blocks.SKELETON_SKULL, Blocks.SKELETON_WALL_SKULL, Blocks.WITHER_SKELETON_SKULL, Blocks.WITHER_SKELETON_WALL_SKULL, Blocks.PLAYER_HEAD, Blocks.PLAYER_WALL_HEAD, Blocks.ZOMBIE_HEAD, Blocks.ZOMBIE_WALL_HEAD, Blocks.CREEPER_HEAD, Blocks.CREEPER_WALL_HEAD, Blocks.PIGLIN_HEAD, Blocks.PIGLIN_WALL_HEAD, Blocks.DRAGON_HEAD, Blocks.DRAGON_WALL_HEAD);
        ...
        tag(Tags.Blocks.STONES).add(Blocks.ANDESITE, Blocks.DIORITE, Blocks.GRANITE, Blocks.INFESTED_STONE, Blocks.STONE, Blocks.DEEPSLATE, Blocks.INFESTED_DEEPSLATE, Blocks.TUFF);
        ...
        tag(Tags.Blocks.COBBLESTONES).addOptional(new ResourceLocation("forge", "cobblestone"));
        tag(Tags.Blocks.COBBLESTONES_NORMAL).addOptional(new ResourceLocation("forge", "cobblestone/normal"));
        tag(Tags.Blocks.COBBLESTONES_INFESTED).addOptional(new ResourceLocation("forge", "cobblestone/infested"));
        tag(Tags.Blocks.COBBLESTONES_MOSSY).addOptional(new ResourceLocation("forge", "cobblestone/mossy"));
        tag(Tags.Blocks.COBBLESTONES_DEEPSLATE).addOptional(new ResourceLocation("forge", "cobblestone/deepslate"));
        ...
        tag(Tags.Blocks.GLASS_BLOCKS).addOptional(new ResourceLocation("forge", "glass"));
        tag(Tags.Blocks.GLASS_BLOCKS_COLORLESS).addOptional(new ResourceLocation("forge", "glass_colorless"));
        tag(Tags.Blocks.GLASS_BLOCKS_CHEAP).addOptional(new ResourceLocation("forge", "glass_silica"));
        tag(Tags.Blocks.GLASS_BLOCKS_TINTED).addOptional(new ResourceLocation("forge", "glass_tinted"));
        tag(Tags.Blocks.GLASS_PANES_COLORLESS).addOptional(new ResourceLocation("forge", "glass_panes_colorless"));
