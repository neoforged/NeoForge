...
public final class NeoForgeItemTagsProvider extends ItemTagsProvider {
    ...
    public void addTags(HolderLookup.Provider lookupProvider) {
        ...
        tag(Tags.Items.FOODS_FRUIT).add(Items.APPLE, Items.GOLDEN_APPLE, Items.ENCHANTED_GOLDEN_APPLE, Items.MELON_SLICE, Items.GLISTERING_MELON_SLICE);
        ...
        tag(Tags.Items.FOODS_GOLDEN).add(Items.GOLDEN_APPLE).add(Items.ENCHANTED_GOLDEN_APPLE).add(Items.GOLDEN_CARROT).add(Items.GLISTERING_MELON_SLICE);
