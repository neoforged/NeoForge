...
public class DeferredDataComponentType<TComponent> extends DeferredHolder<DataComponentType<?>, DataComponentType<TComponent>> {
     ...
     */
    public static <TComponent> DeferredDataComponentType<TComponent> createDataComponentType(ResourceKey<DataComponentType<?>> registryKey) {
     ...
     */
    public static <TComponent> DeferredDataComponentType<TComponent> createDataComponentType(ResourceLocation registryName) {
