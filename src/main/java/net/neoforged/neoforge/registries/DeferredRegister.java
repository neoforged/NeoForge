...
public class DeferredRegister<T> {
    ...
    public static class Items extends DeferredRegister<Item> {
         ...
         * @return A {@link DeferredItem} representing the registered BlockItem
         */
        public <I extends BlockItem> DeferredItem<I> registerCustomBlockItem(String name, Supplier<I> sup) {
            return this.registerItem(name, props -> sup.get(), () -> new Item.Properties().useBlockDescriptionPrefix());
        }
         ...
         * @return A {@link DeferredItem} representing the registered BlockItem
         */
        public <I extends BlockItem> DeferredItem<I> registerCustomBlockItem(String name, Supplier<I> sup, Supplier<Item.Properties> properties) {
