...
public class NeoForgeRegistries {
    ...
    public static final Registry<AttachmentHolderSyncHandler> ATTACHMENT_HOLDER_SYNC_HANDLERS = new RegistryBuilder<>(Keys.ATTACHMENT_HOLDER_SYNC_HANDLERS).create();
    ...
    public static final class Keys {
        ...
        public static final ResourceKey<Registry<AttachmentHolderSyncHandler>> ATTACHMENT_HOLDER_SYNC_HANDLERS = key("attachment_holder_sync_handlers");
