...
public class RegistryManager {
    ...
    @Nullable
    public static <R, T> DataMapType<R, T> getDataMap(ResourceKey<? extends Registry<R>> registry, ResourceLocation key) {
        final var map = dataMaps.get(registry);
        return map == null ? null : (DataMapType<R, T>) map.get(key);
    }
