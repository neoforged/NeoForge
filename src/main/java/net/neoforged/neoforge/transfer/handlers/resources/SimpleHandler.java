...
/**
 * A simple handler that wraps an {@link IResourceHandler} and provides a simplified interface without
 ...
 */
public record SimpleHandler<T extends IResource>(IResourceHandler<T> handler) {
    /**
