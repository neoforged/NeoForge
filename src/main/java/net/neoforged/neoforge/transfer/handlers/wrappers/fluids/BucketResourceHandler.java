...
public final class BucketResourceHandler implements ISingleResourceHandler<FluidResource> {
    ...
    public int insert(FluidResource resource, int amount, TransactionContext transaction) {
        if(itemContext.isReadOnly()) return 0;
        ...
        return itemContext.exchange(filledBucket, bucketsToFill, transaction) * FluidType.BUCKET_VOLUME;
    }
