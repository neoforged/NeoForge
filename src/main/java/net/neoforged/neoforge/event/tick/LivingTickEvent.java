...
public abstract class LivingTickEvent extends LivingEvent {
     ...
     * <p>
     * This event will fire on both the logical server and logical client.
     * <p>
    ...
    /**
     * {@link LivingTickEvent.Post} is fired once per game tick, per player, after the player performs work for the current tick.
     * <p>
