...
public abstract class BlockEvent extends Event {
     ...
     */
    public static class ToolCheck extends BlockEvent {
         ...
         */
        public ToolCheck(LevelAccessor level, BlockPos pos, BlockState state, @Nullable LivingEntity entity, ItemStack tool) {
            super(level, pos, state);
            this.entity = entity;
            this.tool = tool;
        }
