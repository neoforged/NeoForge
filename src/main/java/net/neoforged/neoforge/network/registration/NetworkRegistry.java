...
public class NetworkRegistry {
    ...
    public void setup() {
        ...
        ModLoader.get().postEventWrapContainerInModOrder(new RegisterPayloadHandlerEvent(namespace -> registrarsByNamespace.computeIfAbsent(namespace, ModdedPacketRegistrar::new)));
