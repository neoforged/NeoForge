...
public final class FluidStack implements DataComponentHolder {
    ...
    public Tag save(HolderLookup.Provider lookupProvider, Tag prefix) {
        if (this.isEmpty()) {
            ...
            return Util.getOrThrow(CODEC.encode(this, lookupProvider.createSerializationContext(NbtOps.INSTANCE), prefix), IllegalStateException::new);
        }
    }
    ...
    public Tag save(HolderLookup.Provider lookupProvider) {
        if (this.isEmpty()) {
            ...
            return Util.getOrThrow(CODEC.encodeStart(lookupProvider.createSerializationContext(NbtOps.INSTANCE), this), IllegalStateException::new);
        }
    }
    ...
    public static MapCodec<FluidStack> optionalFieldOf(String fieldName) {
        return CODEC.optionalFieldOf(fieldName)
