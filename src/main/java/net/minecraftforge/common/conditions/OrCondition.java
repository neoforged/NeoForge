...
{
    public static final Codec<OrCondition> CODEC = RecordCodecBuilder.create(builder -> builder.group(
          ICondition.LIST_CODEC.fieldOf("values").forGetter(OrCondition::values)
