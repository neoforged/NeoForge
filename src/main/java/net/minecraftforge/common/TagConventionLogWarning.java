...
public final class TagConventionLogWarning
{
    ...
    private static final Map<TagKey<?>, TagKey<?>> LEGACY_FORGE_TAGS = Map.<TagKey<?>, TagKey<?>>ofEntries(
            ...
            createMapEntry(Registries.ITEM, "food", Tags.Items.FOOD),
            createMapEntry(Registries.ITEM, "foods", Tags.Items.FOOD),
            createMapEntry(Registries.ITEM, "raw_meat", Tags.Items.RAW_MEAT_FOOD),
            createMapEntry(Registries.ITEM, "raw_meats", Tags.Items.RAW_MEAT_FOOD),
            createMapEntry(Registries.ITEM, "raw_fish", Tags.Items.RAW_FISH_FOOD),
            createMapEntry(Registries.ITEM, "raw_fishes", Tags.Items.RAW_FISH_FOOD),
            createMapEntry(Registries.ITEM, "cooked_meat", Tags.Items.COOKED_MEAT_FOOD),
            createMapEntry(Registries.ITEM, "cooked_meats", Tags.Items.COOKED_MEAT_FOOD),
            createMapEntry(Registries.ITEM, "cooked_fish", Tags.Items.COOKED_FISH_FOOD),
            createMapEntry(Registries.ITEM, "cooked_fishes", Tags.Items.COOKED_FISH_FOOD),
