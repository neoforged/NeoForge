...
public final class TagConventionLogWarning
{
    ...
    private static final Map<TagKey<?>, TagKey<?>> LEGACY_FORGE_TAGS = Map.<TagKey<?>, TagKey<?>>ofEntries(
            ...
            createMapEntry(Registries.BLOCK, "sand", Tags.Blocks.SAND),
            createMapEntry(Registries.BLOCK, "sand/colorless", Tags.Blocks.SAND_COLORLESS),
            createMapEntry(Registries.BLOCK, "sand/red", Tags.Blocks.SAND_RED),
            ...
            createMapEntry(Registries.ITEM, "dusts/prismarine", Tags.Items.DUSTS_PRISMARINE),
            ...
            createMapEntry(Registries.ITEM, "gravel", Tags.Items.GRAVEL),
            createMapEntry(Registries.ITEM, "gunpowder", Tags.Items.GUNPOWDER),
            createMapEntry(Registries.ITEM, "heads", Tags.Items.HEADS),
            createMapEntry(Registries.ITEM, "ingots", Tags.Items.INGOTS),
            createMapEntry(Registries.ITEM, "ingots/brick", Tags.Items.INGOTS_BRICK),
            ...
            createMapEntry(Registries.ITEM, "ingots/nether_brick", Tags.Items.INGOTS_NETHER_BRICK),
            createMapEntry(Registries.ITEM, "leather", Tags.Items.LEATHER),
            ...
            createMapEntry(Registries.ITEM, "netherrack", Tags.Items.NETHERRACK),
            ...
            createMapEntry(Registries.ITEM, "obsidian", Tags.Items.OBSIDIAN),
            ...
            createMapEntry(Registries.ITEM, "armors/leggings", Tags.Items.ARMORS_LEGGINGS),
            createMapEntry(Registries.ITEM, "armors/boots", Tags.Items.ARMORS_BOOTS),
            ...
            createMapEntry(Registries.ITEM, "fruit", Tags.Items.FRUITS_FOODS),
            createMapEntry(Registries.ITEM, "fruits", Tags.Items.FRUITS_FOODS),
            createMapEntry(Registries.ITEM, "vegetable", Tags.Items.VEGETABLES_FOODS),
            createMapEntry(Registries.ITEM, "vegetables", Tags.Items.VEGETABLES_FOODS),
            createMapEntry(Registries.ITEM, "berry", Tags.Items.BERRIES_FOODS),
            createMapEntry(Registries.ITEM, "berries", Tags.Items.BERRIES_FOODS),
            createMapEntry(Registries.ITEM, "bread", Tags.Items.BREADS_FOODS),
            createMapEntry(Registries.ITEM, "breads", Tags.Items.BREADS_FOODS),
            createMapEntry(Registries.ITEM, "cookie", Tags.Items.COOKIES_FOODS),
            createMapEntry(Registries.ITEM, "cookies", Tags.Items.COOKIES_FOODS),
            createMapEntry(Registries.ITEM, "raw_meat", Tags.Items.RAW_MEATS_FOODS),
            createMapEntry(Registries.ITEM, "raw_meats", Tags.Items.RAW_MEATS_FOODS),
            createMapEntry(Registries.ITEM, "raw_fish", Tags.Items.RAW_FISHES_FOODS),
            createMapEntry(Registries.ITEM, "raw_fishes", Tags.Items.RAW_FISHES_FOODS),
            createMapEntry(Registries.ITEM, "cooked_meat", Tags.Items.COOKED_MEATS_FOODS),
            createMapEntry(Registries.ITEM, "cooked_meats", Tags.Items.COOKED_MEATS_FOODS),
            createMapEntry(Registries.ITEM, "cooked_fish", Tags.Items.COOKED_FISHES_FOODS),
            createMapEntry(Registries.ITEM, "cooked_fishes", Tags.Items.COOKED_FISHES_FOODS),
            createMapEntry(Registries.ITEM, "soup", Tags.Items.SOUPS_FOODS),
            ...
            createMapEntry(Registries.BIOME, "is_coniferous", Tags.Biomes.IS_CONIFEROUS),
            ...
            createMapEntry(Registries.BIOME, "is_water", Tags.Biomes.IS_WATER),
