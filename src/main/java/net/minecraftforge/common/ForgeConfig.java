    ...
    public static class Client {
        ...
        Client(ForgeConfigSpec.Builder builder) {
            ...
            compressLanIPv6Addresses = builder
                    .comment("[Deprecated for Removal] When enabled, NeoForge will convert discovered 'Open to LAN' IPv6 addresses to their more compact, compressed representation")
