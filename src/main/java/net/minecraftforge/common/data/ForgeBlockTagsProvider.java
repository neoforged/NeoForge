...
public final class ForgeBlockTagsProvider extends BlockTagsProvider
{
    ...
    public void addTags(HolderLookup.Provider p_256380_)
    {
        ...
        tag(STORAGE_BLOCKS).addTags(STORAGE_BLOCKS_BONE, STORAGE_BLOCKS_COAL, STORAGE_BLOCKS_COPPER, STORAGE_BLOCKS_DIAMOND, STORAGE_BLOCKS_DRIED_KELP, STORAGE_BLOCKS_EMERALD, STORAGE_BLOCKS_GOLD, STORAGE_BLOCKS_HAY, STORAGE_BLOCKS_IRON, STORAGE_BLOCKS_LAPIS, STORAGE_BLOCKS_NETHERITE, STORAGE_BLOCKS_RAW_COPPER, STORAGE_BLOCKS_RAW_GOLD, STORAGE_BLOCKS_RAW_IRON, STORAGE_BLOCKS_REDSTONE, STORAGE_BLOCKS_SLIME);
        tag(STORAGE_BLOCKS_BONE).add(Blocks.BONE_BLOCK);
        ...
        tag(STORAGE_BLOCKS_HAY).add(Blocks.HAY_BLOCK);
