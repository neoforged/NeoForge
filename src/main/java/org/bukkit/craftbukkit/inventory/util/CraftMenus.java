...
public final class CraftMenus {
    ...
    public static void openMerchantMenu(ServerPlayer player, MerchantMenu merchant) {
        ...
        MerchantOffers merchantoffers = minecraftMerchant.getOffers();

        if (!merchantoffers.isEmpty()) {
            player.sendMerchantOffers(merchant.containerId, merchantoffers, level, minecraftMerchant.getVillagerXp(), minecraftMerchant.showProgressBar(), minecraftMerchant.canRestock());
        }
