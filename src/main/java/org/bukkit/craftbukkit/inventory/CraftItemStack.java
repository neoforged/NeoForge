...
public final class CraftItemStack extends ItemStack {
    ...
    public static ItemStackTemplate asNMSTemplate(ItemStack original) {
        return ItemStackTemplate.fromNonEmptyStack(asNMSCopy(original));
    }
    ...
    public static CraftItemStack asCraftMirror(ItemStackTemplate original) {
        return asCraftMirror(original.create());
    }
    ...
    public void setType(Material type) {
        if (getType() == type) {
            ...
            handle.setItem(CraftItemType.bukkitToMinecraft(type).builtInRegistryHolder());
            if (hasItemMeta()) {
