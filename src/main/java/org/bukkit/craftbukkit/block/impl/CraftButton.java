...
public final class CraftButton extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.Switch, org.bukkit.block.data.Directional, org.bukkit.block.data.FaceAttachable, org.bukkit.block.data.Powerable {
    ...
    private static final org.bukkit.craftbukkit.block.data.CraftBlockStateEnum<?, Face> FACE = getEnum(net.minecraft.world.level.block.ButtonBlock.class, "face", Face.class);
    ...
    private static final org.bukkit.craftbukkit.block.data.CraftBlockStateEnum<?, AttachedFace> ATTACH_FACE = getEnum(net.minecraft.world.level.block.ButtonBlock.class, "face", AttachedFace.class);
