    ...
    static void customBiomeAttributeTest(final DynamicTest test) {
        HELPER.generateWorldRegistries(new RegistrySetBuilder().add(Registries.BIOME, context -> {
            ...
            Biome biome = new Biome.BiomeBuilder()
                    ...
                    .setAttribute(EnvironmentAttributes.CREATURE_WORLD_GEN_SPAWN_PROBABILITY, 0F)
                    ...
                    .specialEffects(new BiomeSpecialEffects.Builder().waterColor(4159204).build()).build();
