...
public class CraftingEventTests {
    ...
    static void itemSmeltedEventTest(final DynamicTest test) {
        ...
        test.whenEnabled(listeners -> listeners.forge().addListener((final PlayerEvent.ItemSmeltedEvent event) -> {
        ...
        test.onGameTest(helper -> {
            ...
            player.containerMenu.clicked(2, AbstractContainerMenu.CONTAINER_CLICK_SECONDARY, ContainerInput.PICKUP, player);
            ...
            player.containerMenu.clicked(2, AbstractContainerMenu.CONTAINER_CLICK_PRIMARY, ContainerInput.QUICK_MOVE, player);
