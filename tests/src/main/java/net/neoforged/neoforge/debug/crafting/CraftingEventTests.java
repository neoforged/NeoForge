...
public class CraftingEventTests {
    ...
    static void itemSmeltedEventTest(final DynamicTest test) {
        ...
        test.onGameTest(helper -> {
            ...
            player.containerMenu.clicked(2, InputConstants.MOUSE_BUTTON_RIGHT, ContainerInput.PICKUP, player);
            ...
            player.containerMenu.clicked(2, InputConstants.MOUSE_BUTTON_LEFT, ContainerInput.QUICK_MOVE, player);
